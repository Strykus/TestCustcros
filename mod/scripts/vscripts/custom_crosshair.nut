...
void function customcrossInit(){
    ...
    switch(a_customcrossType){
        case 0:
            custcrossTri = RuiCreate($"ui/crosshair_tri.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
            hasTri = true
        break
        case 1:
            custcrossAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasAlt = true
        break
        case 2:
            custcrossShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasShot = true
        break
        case 3:
            custcrossMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasMas = true
        break
        case 4:
            custcrossWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasWinE = true
        break
        case 5:
            custcrossGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasGl = true
        break
        case 6:
            custcrossMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasMoz = true
        break
        case 7:
            custcrossSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasSmr = true
        break
        case 8:
            custcrossWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasWing = true
        break
        case 9:
            custcrossCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCir = true
        break
        case 10:
            custcrossCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCirS = true
        break
        case 11:
            custcrossCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCharg = true
        break
        case 12:
            custcrossPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasPlus = true
        break
        case 13:
            custcrossLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasLead = true
        break
        case 14:
            custcrossCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCore = true
        break
        case 15:
            custcrossSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasSnipe = true
        break
        case 16:
            custcross40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            has40m = true
        break
        case 17:
            custcrossScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasScor = true
        break
        case 18:
            custcrossRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasRock = true
        break
        case 19:
            custcrossFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasFrag = true
        break
        case 20:
            custcrossArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasArc = true
        break
        case 21:
            custcrossPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasPulse = true
        break
        case 22:
            custcrossGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasGrav = true
        break
        case 23:
            custcrossSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasSatch = true
        break
        case 24:
            custcrossFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasFire = true
        break
        case 25:
            custcrossSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasSmoke = true
        break
        case 26:
            custcrossEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasEmpty = true
        break
    }
    ...
    switch(a_customcrossBType){
        case 0:
            custcrossBTri = RuiCreate($"ui/crosshair_tri.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
            hasBTri = true
        break
        case 1:
            custcrossBAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBAlt = true
        break
        case 2:
            custcrossBShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBShot = true
        break
        case 3:
            custcrossBMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBMas = true
        break
        case 4:
            custcrossBWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBWinE = true
        break
        case 5:
            custcrossBGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBGl = true
        break
        case 6:
            custcrossBMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBMoz = true
        break
        case 7:
            custcrossBSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBSmr = true
        break
        case 8:
            custcrossBWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBWing = true
        break
        case 9:
            custcrossBCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBCir = true
        break
        case 10:
            custcrossBCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBCirS = true
        break
        case 11:
            custcrossBCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBCharg = true
        break
        case 12:
            custcrossBPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBPlus = true
        break
        case 13:
            custcrossBLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBLead = true
        break
        case 14:
            custcrossBCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBCore = true
        break
        case 15:
            custcrossBSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBSnipe = true
        break
        case 16:
            custcrossB40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasB40m = true
        break
        case 17:
            custcrossBScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBScor = true
        break
        case 18:
            custcrossBRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBRock = true
        break
        case 19:
            custcrossBFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBFrag = true
        break
        case 20:
            custcrossBArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBArc = true
        break
        case 21:
            custcrossBPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBPulse = true
        break
        case 22:
            custcrossBGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBGrav = true
        break
        case 23:
            custcrossBSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBSatch = true
        break
        case 24:
            custcrossBFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBFire = true
        break
        case 25:
            custcrossBSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBSmoke = true
        break
        case 26:
            custcrossBEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasBEmpty = true
        break
    }
    ...
    switch(a_customcrossCType){
        case 0:
            custcrossCTri = RuiCreate($"ui/crosshair_tri.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
            hasCTri = true
        break
        case 1:
            custcrossCAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCAlt = true
        break
        case 2:
            custcrossCShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCShot = true
        break
        case 3:
            custcrossCMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCMas = true
        break
        case 4:
            custcrossCWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCWinE = true
        break
        case 5:
            custcrossCGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCGl = true
        break
        case 6:
            custcrossCMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCMoz = true
        break
        case 7:
            custcrossCSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCSmr = true
        break
        case 8:
            custcrossCWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCWing = true
        break
        case 9:
            custcrossCCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCCir = true
        break
        case 10:
            custcrossCCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCCirS = true
        break
        case 11:
            custcrossCCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCCharg = true
        break
        case 12:
            custcrossCPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCPlus = true
        break
        case 13:
            custcrossCLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCLead = true
        break
        case 14:
            custcrossCCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCCore = true
        break
        case 15:
            custcrossCSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCSnipe = true
        break
        case 16:
            custcrossC40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasC40m = true
        break
        case 17:
            custcrossCScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCScor = true
        break
        case 18:
            custcrossCRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCRock = true
        break
        case 19:
            custcrossCFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCFrag = true
        break
        case 20:
            custcrossCArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCArc = true
        break
        case 21:
            custcrossCPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCPulse = true
        break
        case 22:
            custcrossCGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCGrav = true
        break
        case 23:
            custcrossCSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCSatch = true
        break
        case 24:
            custcrossCFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCFire = true
        break
        case 25:
            custcrossCSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCSmoke = true
        break
        case 26:
            custcrossCEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasCEmpty = true
        break
    }
    ...
    switch(a_customcrossDType){
        case 0:
            custcrossDTri = RuiCreate($"ui/crosshair_tri.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
            hasDTri = true
        break
        case 1:
            custcrossDAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDAlt = true
        break
        case 2:
            custcrossDShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDShot = true
        break
        case 3:
            custcrossDMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDMas = true
        break
        case 4:
            custcrossDWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDWinE = true
        break
        case 5:
            custcrossDGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDGl = true
        break
        case 6:
            custcrossDMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDMoz = true
        break
        case 7:
            custcrossDSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDSmr = true
        break
        case 8:
            custcrossDWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDWing = true
        break
        case 9:
            custcrossDCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDCir = true
        break
        case 10:
            custcrossDCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDCirS = true
        break
        case 11:
            custcrossDCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDCharg = true
        break
        case 12:
            custcrossDPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDPlus = true
        break
        case 13:
            custcrossDLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDLead = true
        break
        case 14:
            custcrossDCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDCore = true
        break
        case 15:
            custcrossDSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDSnipe = true
        break
        case 16:
            custcrossD40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasD40m = true
        break
        case 17:
            custcrossDScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDScor = true
        break
        case 18:
            custcrossDRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDRock = true
        break
        case 19:
            custcrossDFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDFrag = true
        break
        case 20:
            custcrossDArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDArc = true
        break
        case 21:
            custcrossDPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDPulse = true
        break
        case 22:
            custcrossDGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDGrav = true
        break
        case 23:
            custcrossDSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDSatch = true
        break
        case 24:
            custcrossDFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDFire = true
        break
        case 25:
            custcrossDSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDSmoke = true
        break
        case 26:
            custcrossDEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 1)
            hasDEmpty = true
        break
    }
        ...
        switch(a_customcrossType){
            ...
            case 1:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasAlt){
                        custcrossAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasAlt = true
                    }
            ...
            case 2:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasShot){
                        custcrossShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasShot = true
                    }
            ...
            case 3:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasMas){
                        custcrossMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasMas = true
                    }
            ...
            case 4:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasWinE){
                        custcrossWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasWinE = true
                    }
            ...
            case 5:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasGl){
                        custcrossGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasGl = true
                    }
            ...
            case 6:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasMoz){
                        custcrossMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasMoz = true
                    }
            ...
            case 7:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasSmr){
                        custcrossSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasSmr = true
                    }
            ...
            case 8:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasWing){
                        custcrossWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasWing = true
                    }
            ...
            case 9:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCir){
                        custcrossCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCir = true
                    }
            ...
            case 10:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCirS){
                        custcrossCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCirS = true
                    }
            ...
            case 11:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCharg){
                        custcrossCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCharg = true
                    }
            ...
            case 12:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasPlus){
                        custcrossPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasPlus = true
                    }
            ...
            case 13:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasLead){
                        custcrossLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasLead = true
                    }
            ...
            case 14:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCore){
                        custcrossCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCore = true
                    }
            ...
            case 15:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasSnipe){
                        custcrossSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasSnipe = true
                    }
            ...
            case 16:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!has40m){
                        custcross40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        has40m = true
                    }
            ...
            case 17:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasScor){
                        custcrossScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasScor = true
                    }
            ...
            case 18:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasRock){
                        custcrossRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasRock = true
                    }
            ...
            case 19:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasFrag){
                        custcrossFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasFrag = true
                    }
            ...
            case 20:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasArc){
                        custcrossArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasArc = true
                    }
            ...
            case 21:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasPulse){
                        custcrossPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasPulse = true
                    }
            ...
            case 22:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasGrav){
                        custcrossGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasGrav = true
                    }
            ...
            case 23:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasSatch){
                        custcrossSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasSatch = true
                    }
            ...
            case 24:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasFire){
                        custcrossFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasFire = true
                    }
            ...
            case 25:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasSmoke){
                        custcrossSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasSmoke = true
                    }
            ...
            case 26:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasEmpty){
                        custcrossEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasEmpty = true
                    }
        ...
        switch(a_customcrossBType){
            ...
            case 1:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBAlt){
                        custcrossBAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBAlt = true
                    }
            ...
            case 2:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBShot){
                        custcrossBShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBShot = true
                    }
            ...
            case 3:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBMas){
                        custcrossBMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBMas = true
                    }
            ...
            case 4:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBWinE){
                        custcrossBWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBWinE = true
                    }
            ...
            case 5:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBGl){
                        custcrossBGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBGl = true
                    }
            ...
            case 6:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBMoz){
                        custcrossBMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBMoz = true
                    }
            ...
            case 7:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBSmr){
                        custcrossBSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBSmr = true
                    }
            ...
            case 8:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBWing){
                        custcrossBWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBWing = true
                    }
            ...
            case 9:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBCir){
                        custcrossBCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBCir = true
                    }
            ...
            case 10:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBCirS){
                        custcrossBCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBCirS = true
                    }
            ...
            case 11:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBCharg){
                        custcrossBCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBCharg = true
                    }
            ...
            case 12:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBPlus){
                        custcrossBPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBPlus = true
                    }
            ...
            case 13:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBLead){
                        custcrossBLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBLead = true
                    }
            ...
            case 14:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBCore){
                        custcrossBCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBCore = true
                    }
            ...
            case 15:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBSnipe){
                        custcrossBSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBSnipe = true
                    }
            ...
            case 16:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasB40m){
                        custcrossB40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasB40m = true
                    }
            ...
            case 17:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBScor){
                        custcrossBScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBScor = true
                    }
            ...
            case 18:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBRock){
                        custcrossBRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBRock = true
                    }
            ...
            case 19:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBFrag){
                        custcrossBFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBFrag = true
                    }
            ...
            case 20:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBArc){
                        custcrossBArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBArc = true
                    }
            ...
            case 21:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBPulse){
                        custcrossBPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBPulse = true
                    }
            ...
            case 22:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBGrav){
                        custcrossBGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBGrav = true
                    }
            ...
            case 23:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBSatch){
                        custcrossBSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBSatch = true
                    }
            ...
            case 24:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBFire){
                        custcrossBFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBFire = true
                    }
            ...
            case 25:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBSmoke){
                        custcrossBSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBSmoke = true
                    }
            ...
            case 26:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasBEmpty){
                        custcrossBEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasBEmpty = true
                    }
        ...
        switch(a_customcrossCType){
            ...
            case 1:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCAlt){
                        custcrossCAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCAlt = true
                    }
            ...
            case 2:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCShot){
                        custcrossCShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCShot = true
                    }
            ...
            case 3:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCMas){
                        custcrossCMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCMas = true
                    }
            ...
            case 4:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCWinE){
                        custcrossCWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCWinE = true
                    }
            ...
            case 5:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCGl){
                        custcrossCGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCGl = true
                    }
            ...
            case 6:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCMoz){
                        custcrossCMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCMoz = true
                    }
            ...
            case 7:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCSmr){
                        custcrossCSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCSmr = true
                    }
            ...
            case 8:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCWing){
                        custcrossCWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCWing = true
                    }
            ...
            case 9:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCCir){
                        custcrossCCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCCir = true
                    }
            ...
            case 10:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCCirS){
                        custcrossCCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCCirS = true
                    }
            ...
            case 11:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCCharg){
                        custcrossCCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCCharg = true
                    }
            ...
            case 12:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCPlus){
                        custcrossCPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCPlus = true
                    }
            ...
            case 13:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCLead){
                        custcrossCLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCLead = true
                    }
            ...
            case 14:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCCore){
                        custcrossCCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCCore = true
                    }
            ...
            case 15:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCSnipe){
                        custcrossCSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCSnipe = true
                    }
            ...
            case 16:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasC40m){
                        custcrossC40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasC40m = true
                    }
            ...
            case 17:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCScor){
                        custcrossCScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCScor = true
                    }
            ...
            case 18:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCRock){
                        custcrossCRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCRock = true
                    }
            ...
            case 19:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCFrag){
                        custcrossCFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCFrag = true
                    }
            ...
            case 20:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCArc){
                        custcrossCArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCArc = true
                    }
            ...
            case 21:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCPulse){
                        custcrossCPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCPulse = true
                    }
            ...
            case 22:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCGrav){
                        custcrossCGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCGrav = true
                    }
            ...
            case 23:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCSatch){
                        custcrossCSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCSatch = true
                    }
            ...
            case 24:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCFire){
                        custcrossCFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCFire = true
                    }
            ...
            case 25:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCSmoke){
                        custcrossCSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCSmoke = true
                    }
            ...
            case 26:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasCEmpty){
                        custcrossCEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasCEmpty = true
                    }
        ...
        switch(a_customcrossDType){
            ...
            case 1:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDAlt){
                        custcrossDAlt = RuiCreate($"ui/crosshair_alternator.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDAlt = true
                    }
            ...
            case 2:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDShot){
                        custcrossDShot = RuiCreate($"ui/crosshair_shotgun.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDShot = true
                    }
            ...
            case 3:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDMas){
                        custcrossDMas = RuiCreate($"ui/crosshair_mastiff.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDMas = true
                    }
            ...
            case 4:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDWinE){
                        custcrossDWinE = RuiCreate($"ui/crosshair_wingman_n.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDWinE = true
                    }
            ...
            case 5:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDGl){
                        custcrossDGl = RuiCreate($"ui/crosshair_grenade_launcher.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDGl = true
                    }
            ...
            case 6:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDMoz){
                        custcrossDMoz = RuiCreate($"ui/crosshair_mozambique.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDMoz = true
                    }
            ...
            case 7:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDSmr){
                        custcrossDSmr = RuiCreate($"ui/crosshair_smr.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDSmr = true
                    }
            ...
            case 8:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDWing){
                        custcrossDWing = RuiCreate($"ui/crosshair_wingman.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDWing = true
                    }
            ...
            case 9:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDCir){
                        custcrossDCir = RuiCreate($"ui/crosshair_circle2.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDCir = true
                    }
            ...
            case 10:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDCirS){
                        custcrossDCirS = RuiCreate($"ui/crosshair_circle2_small.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDCirS = true
                    }
            ...
            case 11:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDCharg){
                        custcrossDCharg = RuiCreate($"ui/crosshair_charge_rifle.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDCharg = true
                    }
            ...
            case 12:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDPlus){
                        custcrossDPlus = RuiCreate($"ui/crosshair_plus.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDPlus = true
                    }
            ...
            case 13:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDLead){
                        custcrossDLead = RuiCreate($"ui/crosshair_leadwall.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDLead = true
                    }
            ...
            case 14:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDCore){
                        custcrossDCore = RuiCreate($"ui/crosshair_flight_core.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDCore = true
                    }
            ...
            case 15:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDSnipe){
                        custcrossDSnipe = RuiCreate($"ui/crosshair_titan_sniper.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDSnipe = true
                    }
            ...
            case 16:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasD40m){
                        custcrossD40m = RuiCreate($"ui/crosshair_40mm.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasD40m = true
                    }
            ...
            case 17:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDScor){
                        custcrossDScor = RuiCreate($"ui/crosshair_scorch.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDScor = true
                    }
            ...
            case 18:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDRock){
                        custcrossDRock = RuiCreate($"ui/crosshair_tracker_rockets.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDRock = true
                    }
            ...
            case 19:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDFrag){
                        custcrossDFrag = RuiCreate($"ui/crosshair_frag.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDFrag = true
                    }
            ...
            case 20:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDArc){
                        custcrossDArc = RuiCreate($"ui/crosshair_arc.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDArc = true
                    }
            ...
            case 21:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDPulse){
                        custcrossDPulse = RuiCreate($"ui/crosshair_pulse_blade.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDPulse = true
                    }
            ...
            case 22:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDGrav){
                        custcrossDGrav = RuiCreate($"ui/crosshair_gravstar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDGrav = true
                    }
            ...
            case 23:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDSatch){
                        custcrossDSatch = RuiCreate($"ui/crosshair_satchel.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDSatch = true
                    }
            ...
            case 24:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDFire){
                        custcrossDFire = RuiCreate($"ui/crosshair_firestar.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDFire = true
                    }
            ...
            case 25:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDSmoke){
                        custcrossDSmoke = RuiCreate($"ui/crosshair_esmoke.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDSmoke = true
                    }
            ...
            case 26:
                if(weapon.GetWeaponClassName() == "mp_weapon_car" || "mp_weapon_wingman" && IsAlive(player)){
                    ...
                    if(!hasDEmpty){
                        custcrossDEmpty = RuiCreate($"ui/crosshair_sniper_amped.rpak", clGlobal.topoFullScreen, RUI_DRAW_HUD, 0)
                        hasDEmpty = true
                    }
